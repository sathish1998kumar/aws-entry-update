                  ...
                  datas.length > 0
                    ...
                    child: Column(
                      children: [
                        ...
                        //                     width: 54,
                        //                     child: FittedBox(
                        //                       child: Text('${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(sumover)}',
                        //                           style: TextStyle(
                        //                               fontSize: 18,
                        ...
                        //                     width: 54,
                        //                     child: FittedBox(
                        //                       child: Text('${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(ttweight)}',
                        //                           style: TextStyle(
                        //                               fontSize: 18,
                        //                               fontWeight: FontWeight.bold,color: Colors.orangeAccent)),
                        //                     ),
                        ...
                        //           ),
                        //         ),
                        //         child:Text('${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(sumover)}', style: TextStyle(fontWeight: FontWeight.bold)),
                        //       ),
                        //       Container(
                        //         width: 71,
                        //         // height: MediaQuery.of(context).size.height*0.072*filteredData[x]['vehicles'].length,
                        ...
                        //           ),
                        //         ),
                        //         child:Text('${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(ttweight)}', style: TextStyle(fontWeight: FontWeight.bold)),
                        //       ),
                        //     ],
                        //   ),
                        // ))
                        ...
                        //                   DataCell(Text('${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(sumover)}', style: TextStyle(fontWeight: FontWeight.bold))),
                        //                   DataCell(Text('${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(ttweight)}', style: TextStyle(fontWeight: FontWeight.bold))),
                        //
                        //       ],
                        //     ).toRow(); // Convert DataRow to normal Row
                        //   },
                        // ),
                        // Expanded(
                        //   child: SingleChildScrollView(
                        //     child: DataTable(
                        //       columns: [], // We leave this empty since header is already created
                        //       rows: [
                        //         for (int x = 0;
                        //         x < filteredData.length;
                        //         x++) ...[
                        //           // if(datas[x]['vehicles'][0]['weight']!="no")...[
                        //           DataRow(cells: [
                        //             DataCell(Text('${x + 1}')),
                        //             DataCell(Text(filteredData[x]
                        //             ['vehicle_no']
                        //                 .length ==
                        //                 13
                        //                 ? '${filteredData[x]['vehicle_no'].substring(0, 8)} \n    ${filteredData[x]["vehicle_no"].substring(filteredData[x]["vehicle_no"].length - 4)}\n(Emt-${filteredData[x]['vehicles'][0]['empty_weight']})'
        ...
        child: InkWell(
          onTap: () {
            ...
            _showMyDialog(context, index0, index1, index2, index3,
                datas1[index]['vehicle_no'], datas1[index]['driver_name']);
          },
          child: Chip(
              label: FittedBox(
                child: Text(
  ...
  children: [
    for (int x = 0; x < datas1[index]['vehicles'].length; x++) ...[
      Padding(
        padding: const EdgeInsets.fromLTRB(0, 15, 0, 0),
        child: Text(
          // '${NumberFormat.currency(locale: 'en_IN',symbol: '',decimalDigits:0).format(int.datas1[index]['vehicles'][x]['weight'])}',
    ...
    for (int x = 0; x < datas1[index]['vehicles'].length; x++) ...[
      ...
      Padding(
        ...
        child: Text(
          ...
          '${int.parse(datas1[index]['vehicles'][x]['weight']) - int.parse(datas1[index]['vehicles'][x]['empty_weight'])}',
          style:
          TextStyle(fontWeight: FontWeight.bold, color: Colors.black),
        ),
      ),
...
Future<void> _showMyDialog(BuildContext context, int index0, int index1,
    int index2, int index3, String? vehicle, String? driver) async {
